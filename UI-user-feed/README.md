...
## Candidate Notes:
- Paste the file on any localhost server.
- Open the file using localhost server link.
- You will see the output on the screen.
- To add new comment you can type the new comment in text input on top of page and click enter.